...
The line provided by geom_smooth() is mostly horizontal with a few oscillations. It sems like population density is not very correlated with new deaths per 100k. 
...
filter_dates <- seq(as.Date("2022-06-15"), as.Date("2022-11-01"), by=14)
